...
- (void)viewDidLoad {
    ...
    userNameField = [[UITextField alloc]initWithFrame:CGRectMake(SCREEN_WIDTH/22, SCREEN_HEIGHT/11, SCREEN_WIDTH - 30 , 50)];
    ...
    reEnterPasswordField = [[UITextField alloc]initWithFrame:CGRectMake(SCREEN_WIDTH/22, SCREEN_HEIGHT/3.4, SCREEN_WIDTH - 30 , 50)];
